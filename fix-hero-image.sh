            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="relative aspect-square max-w-lg mx-auto">
                <div className="relative overflow-hidden rounded-lg bg-cyber-black">
                  ...
                  {/* OVERLAY TO HIDE CODEFLEX TEXT */}
                  <div className="absolute bottom-[20%] left-1/2 -translate-x-1/2 bg-background/95 backdrop-blur-sm w-32 h-14 rounded-lg" />
                  
                  {/* OPTIONAL: Add custom badge */}
                  <div className="absolute bottom-[20%] left-1/2 -translate-x-1/2 bg-black/80 backdrop-blur-sm px-4 py-2 rounded-full border border-primary/30">
                    <span className="text-primary text-xs font-bold tracking-wider uppercase">Performance</span>
                  </div>
